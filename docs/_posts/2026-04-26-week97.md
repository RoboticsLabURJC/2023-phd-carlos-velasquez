...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week97/curve_route.png" style="width:50%">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week97/curve_collisions.png" style="width:50%">
  <figcaption>Robustez y colisiones vs % de augmentación</figcaption>
</figure>

<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week97/curve_dev.png" style="width:50%">
...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week97/output.png" alt="DAgger vs Noise: robustez, colisiones y velocidad" style="width:50%">
