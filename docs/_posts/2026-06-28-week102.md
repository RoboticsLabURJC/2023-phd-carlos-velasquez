...
| Modelo             |     Successful Runs | Collisions | Lane Inv. | Speed (km/h) | Dev Mean (m) |
| ------------------ | ------------------: | ---------: | --------: | -----------: | -----------: |
| $D^{A}$            | **98.7% (222/225)** |  **0.000** |     7.908 |        55.33 |    **0.468** |
| $D_{0.15}^{B}$     |     98.2% (221/225) |  **0.000** | **7.412** |    **59.91** |        0.487 |
| $D_{0.30}^{B}$     |     96.9% (218/225) |      1.000 |     9.875 |        55.63 |        0.558 |
| $D_{0.50}^{B}$     | **98.7% (222/225)** |  **0.000** |     8.590 |        57.33 |        0.536 |
| $D_{0.75}^{B}$     |     53.8% (121/225) |      0.835 |    15.438 |        50.48 |        0.780 |
| $D_{0.15}^{C}$     |     98.7% (222/225) |  **0.000** |     8.189 |        53.31 |        0.477 |
| $D_{0.30}^{C}$     |     97.3% (219/225) |  **0.000** |     7.563 |        59.42 |        0.486 |
| $D_{0.50}^{C}$     |     78.2% (176/225) |  **0.000** |     8.443 |        57.18 |        0.500 |
| $D_{0.75}^{C}$     |     55.6% (125/225) |      0.528 |     8.688 |        53.69 |        0.591 |
| $D^{M}_{30/30/40}$ |     71.4% (160/224) |      0.081 | **6.688** |        57.14 |        0.546 |
...
| ------------------ | -------------------: | ---------: | -------------: | -----------: | -----------: |
| $D^{A}$            | **100.0% (225/225)** |  **0.000** |          9.444 |        54.71 |    **0.767** |
| $D_{0.15}^{B}$     |  **98.2% (221/225)** |      0.103 |      **8.732** |    **60.75** |        0.782 |
| $D_{0.30}^{B}$     |      94.7% (213/225) |      1.004 |         11.649 |        55.25 |        0.816 |
| $D_{0.50}^{B}$     |      97.3% (219/225) |  **0.000** |         10.421 |        56.65 |        0.825 |
| $D_{0.75}^{B}$     |       40.4% (91/225) |      1.024 |         17.138 |        47.17 |        0.945 |
| $D_{0.15}^{C}$     |      96.9% (218/225) |      0.147 |          9.688 |        53.91 |        0.779 |
| $D_{0.30}^{C}$     |      96.4% (217/225) |  **0.000** |      **8.604** |        59.39 |        0.776 |
| $D_{0.50}^{C}$     |      74.2% (167/225) |      0.004 |          9.295 |        56.49 |    **0.765** |
| $D_{0.75}^{C}$     |      45.3% (102/225) |      0.570 |         10.272 |        53.45 |        0.804 |
| $D^{M}_{30/30/40}$ |      61.6% (138/224) |      0.065 |      **7.790** |        56.79 |            — |
...
| Modelo         |     Successful Runs | Collisions | Lane Inv. | Speed (km/h) | Dev Mean (m) |
| -------------- | ------------------: | ---------: | --------: | -----------: | -----------: |
| $D^{A}$        |     73.8% (166/225) |      0.018 | **2.484** |    **45.12** |    **0.499** |
| $D_{0.15}^{B}$ |     98.7% (222/225) |      0.009 |     2.153 |        46.83 |        0.592 |
| $D_{0.30}^{B}$ |     98.2% (221/225) |      0.586 |     2.127 |        44.04 |        0.597 |
| $D_{0.50}^{B}$ | **99.1% (223/225)** |  **0.000** |     2.333 |        45.11 |        0.663 |
| $D_{0.75}^{B}$ | **99.1% (223/225)** |      0.432 |     3.788 |        41.16 |        0.779 |
| $D_{0.15}^{C}$ |     98.2% (221/225) |      0.032 |     2.356 |        43.52 |        0.572 |
| $D_{0.30}^{C}$ |     72.0% (162/225) |      0.487 |     3.955 |        43.89 |    **0.484** |
| $D_{0.50}^{C}$ |     72.9% (164/225) |  **0.000** |     2.079 |        44.81 |        0.557 |
...
| Modelo             |     Successful Runs | Collisions | Lane Inv. | Speed (km/h) | Dev Mean (m) |
| ------------------ | ------------------: | ---------: | --------: | -----------: | -----------: |
| $D^{A}$            |     88.0% (198/225) |  **0.025** |     8.993 |        54.34 |        0.486 |
| $D^{M}_{70/20/10}$ |     47.1% (106/225) |      0.264 |     8.887 |        53.53 |        0.717 |
| $D^{M}_{30/30/40}$ |     57.3% (129/225) |      0.147 | **7.876** |        52.39 |        0.677 |
| $D_{0.15}^{B}$     |      30.2% (68/225) |      0.221 | **7.760** |    **56.82** |        0.593 |
| $D_{0.30}^{B}$     |     71.1% (160/225) |      0.994 |    11.341 |        53.93 |        0.640 |
| $D_{0.50}^{B}$     |     62.2% (140/225) |      0.129 |    10.604 |        54.55 |        0.701 |
| $D_{0.75}^{B}$     |      20.0% (45/225) |      0.978 |    18.800 |        47.65 |        0.817 |
| $D_{0.15}^{C}$     |     82.2% (185/225) |      0.076 |     9.752 |        52.92 |        0.530 |
| $D_{0.30}^{C}$     |     79.6% (179/225) |      0.179 |     8.485 |        56.17 |        0.554 |
| $D_{0.50}^{C}$     | **91.1% (205/225)** |      0.054 |     9.034 |        54.61 |    **0.466** |
| $D_{0.75}^{C}$     |     47.1% (106/225) |      0.509 |    11.562 |        52.20 |        0.828 |



### Perturbación intensificada

| Modelo         | Perturbación |     Successful Runs | Collisions | Lane Inv. | Speed (km/h) | Dev Mean (m) |
| -------------- | ------------ | ------------------: | ---------: | --------: | -----------: | -----------: |
| $D_{0.30}^{B}$ | Suave        |     71.1% (160/225) |      0.994 |    11.341 |        53.93 |        0.640 |
| $D_{0.30}^{B}$ | Fuerte       |     73.8% (166/225) |      0.837 |     8.619 |        55.98 |        0.595 |
| $D_{0.30}^{C}$ | Suave        |     79.6% (179/225) |      0.179 |     8.485 |        56.17 |        0.554 |
| $D_{0.30}^{C}$ | **Fuerte**   | **85.8% (193/225)** |  **0.197** | **6.430** |    **58.34** |    **0.546** |
