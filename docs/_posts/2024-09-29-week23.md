...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week23/mask.png" alt="" style="width:100%">
  <figcaption>Mask Image</figcaption>
</figure>

<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week23/overlayed_img.png" alt="" style="width:100%">
  <figcaption>Overlayed Image</figcaption>
</figure>
