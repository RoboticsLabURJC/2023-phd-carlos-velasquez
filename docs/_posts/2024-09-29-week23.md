...
<div style="display: flex; justify-content: space-between;">
  <figure style="margin: 0 10px;">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week21/rgb_image.png" alt="Imagen RGB" style="width: 100%;">
    <figcaption>Imagen RGB</figcaption>
  </figure>
  <figure style="margin: 0 10px;">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week21/prediction_mask.png" alt="Máscara de Predicción" style="width: 100%;">
