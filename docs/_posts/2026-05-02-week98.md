...
<figure>
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week98/chart_route_speed.png" alt="Route completed y Average Speed vs proporción de mezcla" style="width:100%">
  <figcaption>Test 0 (caso canónico): Route completed (%) y Average Speed (km/h) en función de la proporción de mezcla. La zona sombreada marca el rango óptimo A'+B' (30–50%). El colapso de A'+75%B' es visible en ambas métricas.</figcaption>
</figure>
...
<figure>
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week98/chart_dev_collisions.png" alt="Desviación lateral y colisiones vs proporción de mezcla" style="width:100%">
  <figcaption>Test 0 (caso canónico): Desviación lateral media (m) y colisiones promedio en función de la proporción de mezcla. A'+B' domina en control lateral en todo el rango estable. A'+100%C' invierte la tendencia en colisiones (0.011).</figcaption>
</figure>
...
<figure>
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week98/chart_lane_suddenness.png" alt="Lane invasions y Suddenness vs proporción de mezcla" style="width:100%">
...
<figure>
  ...
  <figcaption>Test 0 (caso canónico): robustez (eje Y), colisiones (eje X) y velocidad promedio (tamaño de burbuja) para todas las proporciones de mezcla de A'+B' (azul) y A'+C' (verde). Zona objetivo: esquina superior izquierda.</figcaption>
</figure>
...
La política B' se aplica periódicamente durante la inferencia sobre el Test 0 (caso canónico): cada 8 s se ejecuta una perturbación estructural forzada durante 4 ticks (0.2 s), seguida de 10 ticks de recuperación (0.5 s).
...
<figure>
  ...
  <figcaption>Test 4 (perturbación estructural B' en inferencia sobre Test 0): A'+30%B' mantiene su rendimiento nominal; el Mix colapsa a 81.2% de completado.</figcaption>
</figure>
