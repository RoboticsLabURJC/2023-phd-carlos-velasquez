...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week41/behaviorMetrics.png" alt="" style="width:70%">
  <figcaption>experto recta</figcaption>
</figure>


<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week41/topics.png" alt="" style="width:70%">
  <figcaption>experto recta</figcaption>
</figure>
