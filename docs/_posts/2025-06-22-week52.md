...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week52/steer_plot_resnet18.png" alt="ResNet18 Steer" style="width:90%">
...
### Evaluación Cualitativa en Simulación
