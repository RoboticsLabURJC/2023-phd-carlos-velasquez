---
title: Week 24 - EfficientNet: Entrenamiento del Clasificador de Curvatura
categories:
    - weekly Log
tags:
    - CARLA 0.9.14
...
Se eligió el modelo EfficientNet\_B0 para entrenar un clasificador de curvatura, con el objetivo de detectar dos clases: curva  y recta . Para este entrenamiento, se construyó un dataset balanceado  (mismo número de ejemplos de curvas y rectas), compuesto por 36,000 imágenes RGB  etiquetadas según la curvatura.
