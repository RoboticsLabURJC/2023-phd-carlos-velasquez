...
| ---------------------------- | ----------: | ----------------------------------- | ---------: | ------------------------------------------ | ----------------------------------------------------------- |
| **Burbuja (baseline)**       |  **45 000** | 100% conducción nominal             |    6 towns | Imágenes segmentadas + `steer`, `throttle` | Aprender conducción estable y suave en condiciones normales |                  |
| **Burbuja + DAgger (mixto)** |  **60 600** | 45k Burbuja + 15.6k DAgger (≈74/26) |    6 towns | Imágenes segmentadas + `steer`, `throttle` | Aumentar robustez sin degradar estabilidad                  |
