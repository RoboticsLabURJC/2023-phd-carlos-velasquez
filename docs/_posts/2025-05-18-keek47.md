...
![alt text](../assets/images/week47/bubble_vs_dagger.png)
> Color de la trayectoria indica la desviación: de amarillo (baja) a rojo (alta)

<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/week47/bubble_vs_dagger.png" alt="" style="width:100%">
  <figcaption>bubble_vs_dagger</figcaption>
</figure>
