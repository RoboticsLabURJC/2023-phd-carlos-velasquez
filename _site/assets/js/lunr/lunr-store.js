var store = [{
        ...
        "title": "Week 90 - Recorder/Replayer, muestreo temporal y revisión de augmentations en PilotNet",
        "excerpt":"Durante esta etapa se implementó una nueva pipeline de generación de datasets basada en dos herramientas: Recorder Replayer El objetivo fue separar la captura de conducción humana de la generación del dataset final, permitiendo reutilizar una misma sesión de conducción múltiples veces. Arquitectura de adquisición de datos El flujo general...","categories": ["weekly Log"],
        "tags": ["Dataset","CARLA","Data Collection","PilotNet","Augmentations"],
        "url": "/weekly%20log/week90/",
        "teaser": null
      },{
        "title": "Week 91 - Entrenamiento en caliente",
        "excerpt":"Estratificación del dataset Para modelar los estados de conducción se definió una estratificación conjunta steer × throttle, generando 20 clases discretas. Clasificación del steer Clase Descripción 0 fuerte izquierda 1 suave izquierda 2 recto 3 suave derecha 4 fuerte derecha Clasificación del throttle Clase Descripción 0 muy lento 1 lento...","categories": ["weekly Log"],
        "tags": ["Dataset","CARLA","Data Collection","PilotNet","Augmentations"],
        "url": "/weekly%20log/week91/",
        "teaser": null
      },{
        "title": "Week 92 - Entrenamiento en caliente",
        "excerpt":"Estratificación del dataset (muestreado a 20Hz) Para modelar los estados de conducción se definió una estratificación conjunta steer × throttle, generando 20 clases discretas. Clasificación del steer Clase Descripción 0 fuerte izquierda 1 suave izquierda 2 recto 3 suave derecha 4 fuerte derecha Clasificación del throttle Clase Descripción 0 muy...","categories": ["weekly Log"],
        "tags": ["Dataset","CARLA","Data Collection","PilotNet","Augmentations"],
        "url": "/weekly%20log/week92/",
        "teaser": null
      },{
        "title": "Week 93 -  Dataset Noise injection",
        "excerpt":"Noise Injection y generación del dataset Durante esta etapa se aplicó la estrategia de noise injection para mejorar la robustez del modelo frente a desviaciones de trayectoria. Se mantuvo la misma metodología de captura basada en recorder + replayer, grabando primero la sesión en un archivo .log junto con un...","categories": ["weekly Log"],
        "tags": ["Dataset","CARLA","Data Collection","PilotNet","Augmentations"],
        "url": "/weekly%20log/week93/",
        "teaser": null
      },{
        "title": "Week 94 - Construcción de datasets Noise Injection y DAgger",
        "excerpt":"Avances en construcción de dataset y entrenamiento PilotNet Durante esta fase persiste el problema de sincronización entre el archivo *.log del recorder de CARLA y el archivo CSV externo, utilizado para almacenar la acción humana sobre steer. El procedimiento implementado busca establecer correspondencia entre: imagen segmentada (image_seg) etiqueta humana (steer_human)...","categories": ["weekly Log"],
        "tags": ["Dataset","CARLA","Data Collection","PilotNet","Augmentations"],
        "url": "/weekly%20log/week94/",
        "teaser": null
      },{
        "title": "Week 95 - Robustez del piloto, Caso Canónico, 15 Casos y Pruebas de Velocidad",
        "excerpt":"En esta entrada reporto los resultados de robustez en CARLA Town02 comparando tres políticas/datasets bajo el mismo circuito de prueba, con 6 repeticiones por condición (valores reportados como promedio de las repeticiones). Circuito base Caso canónico: recorrido siguiendo la malla externa (outer loop) de Town02, manteniéndose en el carril derecho....","categories": ["weekly Log"],
        "tags": ["Robustez","Burbuja","Noise Injectio","DAgger","CARLA Simulator"],
        "url": "/weekly%20log/week95/",
        "teaser": null
      },{
        "title": "Week 96 - Robustez del piloto, Caso Canónico, 15 Casos y Pruebas de Velocidad",
        "excerpt":"En esta entrada reporto los resultados de robustez en CARLA Town02 comparando tres variantes del mismo dataset base bajo el mismo circuito de prueba, con 6 repeticiones por condición (valores reportados como promedio de las repeticiones). Circuito base Caso canónico: recorrido siguiendo la malla externa (outer loop) de Town02, manteniéndose...","categories": ["weekly Log"],
        "tags": ["Robustez","Burbuja","Noise Injection","DAgger","CARLA Simulator"],
        "url": "/weekly%20log/week96/",
        "teaser": null
      },{
        "title": "Week 97 - Busqueda de la proporcion optima, mezcla Burbuja–DAgger vs Burbuja–Noise en conduccion autonoma",
        "excerpt":"Análisis de mezclas Burbuja + DAgger Tabla resumen – DAgger Métrica DAgger 5% DAgger 15% DAgger 30% DAgger 50% Mejor Route completed (%) 97.600 98.900 99.200 99.400 DAgger 50% Average speed (km/h) 53.800 59.900 62.800 64.100 DAgger 50% Dev mean (m) 0.620 0.640 0.655 0.670 DAgger 5% Lane invasions (eventos)...","categories": ["weekly Log"],
        "tags": ["Robustez","Burbuja","Noise Injection","DAgger","CARLA Simulator"],
        "url": "/weekly%20log/week97/",
        "teaser": null
      },{
